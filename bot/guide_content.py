...
WELCOME_DEFAULT = (
    ...
    "Здесь можно получить гайд или записаться на услугу."
)

BOOKING_INTRO = "Выберите эксперта:"
BOOKING_SUCCESS = (
    "✅ <b>Заявка принята!</b>\n\n"
    "Мы получили ваш выбор и свяжемся с вами в Telegram, чтобы уточнить детали записи."
)
