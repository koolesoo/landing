...
QUESTION_WELCOME = (
    "Ты перешел с сайта — можешь задать вопрос менторам прямо здесь."
)

QUESTION_PROMPT = (
    "Напиши свой вопрос одним сообщением — передадим его менторам и ответим в Telegram."
)

QUESTION_SUCCESS = (
    "✅ <b>Спасибо!</b> Мы получили твой вопрос и скоро ответим здесь в чате."
)
